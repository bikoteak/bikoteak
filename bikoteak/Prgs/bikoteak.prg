...
close all
clear all
* Se crean dos variables públicas, una destinada a ser el
* objeto de la clase entorno y otra que nos servirá para que
* se ejecuten o no ciertas partes de la aplicación dependiendo
...
* funcionar en nuestra aplicación. Aquí podemos especificar
...
* y métodos. Por tanto ejecutamos el método setup que 
* configura el entorno
oapp.setup
* Llamamos al menú principal que permanecerá en pantalla
* durante toda la aplicación y activamos el estado de espera
* mediante read events, lo que permite que se quede el menú
* hasta que elijamos la opción concluir, en la cual pondremos
* un clear events
