...
do while .not. eof()
   if listas = 1
      ...
      ?
      ?
      ? space(15),"XXI Open Internacional d'Escacs d'Andorra"
      ?
      ? "Ciudad:","Andorra la Vella",space(10),"Pais:","AND"
      ? "Comienzo:","05-07-03",space(3),"Primer periodo:",torneo.prim_per
      ? "Final   :","13-07-03",space(3),"Segundo periodo:",torneo.segu_per
      ? "Arbitro:",arbitro,space(3),"Fed:","ESP"
      ?
   endif
   guarda3 = recno()
   if tipo_list < 3 
      ...
      do while i < 6 .and. .not. eof()
         ?? iif(jugadore.licencia = 0,"   " + str(jugadore.fecha_naci,8),;
